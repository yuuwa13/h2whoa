...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('h2whoa_user/assets/fonts/font-awesome.min.css') }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center d-flex justify-content-center align-items-center mb-3">
                                <img src="{{ asset('h2whoa_user/assets/img/elements/h2whoa_logo.png') }}" alt="H2WHOA Logo" style="max-width: 60px; height: auto; margin-right: 10px;">

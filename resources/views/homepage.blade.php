...
<body>
    <main class="page blog-post">
        <section class="clean-block clean-post dark">
            <div class="container py-4 py-xl-5"><img width="100" height="80" src="{{ asset('h2whoa/assets/img/assets/h2whoa_logo.png')}}">
                <div class="row row-cols-1 row-cols-md-2">
                    ...
                    <div class="col" style="margin-top: 12px;width: 644px;height: 644px;"><img class="rounded w-500 h-100 fit-cover" style="min-height: 644px;width: 300px;height: 644px;max-height: 644px;" src="{{asset ('h2whoa/assets/img/assets/Homepage_h2whoa.png')}}" width="201" height="644"></div>
                </div>
                <div class="btn-group" role="group"><button class="btn btn-primary" type="button" style="background: #4ac9b0;width: 105.6719px;margin-left: 46px;">LOG IN&nbsp;</button><button class="btn btn-primary" type="button" style="margin-right: 12px;margin-left: 57px;background: #4ac9b0;">REGISTER NOW</button></div>
            </div>
            <div class="container">

  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-danger">
      ...
      <div class="modal-footer">
        ...
        <button type="button"
                class="btn btn-danger"
                id="confirmDelete">Yes, Delete My Account</button>
      </div>
    </div>
  </div>
</div>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      @forelse($editLogs as $log)
        <tr>
          <td>{{ \Carbon\Carbon::parse($log->changed_at)
      ...
      @empty
        <tr><td colspan="4" class="text-center">No edits yet.</td></tr>
      @endforelse
    </tbody>
  </table>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1) On “Edit Profile” click → unlock inputs, show action, hide editBtn

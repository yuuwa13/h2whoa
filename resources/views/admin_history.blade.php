...
<head>
    ...
    <title>Shopping Cart - H2WHOA</title>
...
<body>
    <nav class="navbar navbar-expand-lg fixed-top bg-body clean-navbar navbar-light" style="width: 1335px;height: 163px;margin-left: 32px;margin-top: 30px;border-radius: 42px;">
        <div class="container"><a class="navbar-brand logo" href="#index.html"><img width="100" height="80" src="{{ asset('h2whoa/assets/img/assets/h2whoa_logo.png')}}">H2WHOA&nbsp;&nbsp;</a><button data-bs-toggle="collapse" data-bs-target="#navcol-1" class="navbar-toggler"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse text-start" id="navcol-1" style="margin-left: 584px;">
                <ul class="navbar-nav ms-auto" style="margin-left: 9px;">
                    <li class="nav-item" style="margin-left: 102px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bell" style="font-size: 31px;">
                            <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2M8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6"></path>
                        </svg></li>
                    <li class="nav-item" style="margin-left: 5px;"><i class="far fa-user" style="font-size: 32px;"></i></li>
                </ul><a style="font-size: 22px;"><strong>Station</strong><br>Attendant</a>
    ...
    <main class="page shopping-cart-page">
        <section class="clean-block clean-cart dark">
            ...
            <div class="container-fluid" style="margin-top: 87px;margin-left: 25px;margin-right: 25px;width: 800px;">
                ...
                <div class="content">
                    <div class="row g-0">
                        <div class="col-md-12 col-lg-8">
                            <div class="items">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-6" style="margin-top: 75px;">
                                        <h3 class="text-dark mb-4"><a class="navbar-brand logo" href="#index.html"><img width="100" height="80" src={{ asset('h2whoa/assets/img/assets/Homepage_h2whoa.png') }}>History</a></h3>
                                    </div>
                                    <div class="col"><a class="btn btn-primary" role="button" style="background: #4ac9b0;margin-top: 114px;margin-right: 17px;margin-left: 187px;"><i class="fa fa-plus"></i>Generate Report</a></div>
                                </div>
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table class="table table-striped table tablesorter" id="ipi-table">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th class="text-center" style="font-size: 16px;">order</th>
                                                    <th class="text-center" style="font-size: 16px;">Items</th>
                                                    <th class="text-center" style="font-size: 16px;">order details</th>
                                                </tr>
                                            </thead>
                                            <tbody class="text-center">
                                                <tr>
                                                    <td style="font-size: 16px;"><br>Onsite<br>order id: 0008<br>date ordered : 09/10/24<br><br></td>
                                                    <td><br>5 wATER GALLON (new) - <br>750.00 6 Gallon cAPS - 180.00<br>2 - Refill water - 80.00<br><br></td>
                                                    <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><br>delivery status: n/a<br>customer: n/a&nbsp;<br><br>payment method: CASH<br>reference number: N/A<br>total price: 1010.00<br>amount paid: 1100.00<br><br></td>
                                                </tr>
                                                <tr>
                                                    <td><br><br>Online<br>order id: 0009<br>date ordered : 09/10/24<br><br></td>
                                                    <td><br>5 wATER GALLON (new) - 750.00<br>6 Gallon cAPS - 180.00<br>2 - Refill water - 80.00<br><br></td>
                                                    <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><br><br>delivery status: n/a<br>customer: n/a&nbsp;<br><br>payment method: CASH<br>reference number: N/A<br>total price: 1010.00<br>amount paid: 1100.00<br><br><br></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="bg-body-tertiary summary">
                                <h3>oPTIONS</h3><button class="btn btn-primary btn-lg d-block w-100" type="button" style="background: #4ac9b0;"><i class="fas fa-sitemap" style="font-size: 22px;margin-right: 33px;"></i>Inventory</button><button class="btn btn-primary btn-lg d-block w-100" type="button" style="background: #4ac9b0;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-clock-history" style="font-size: 24px;margin-right: 33px;">

        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgba(255, 255, 255, 0.04);font-size: 22px;color: rgba(133,135,150,0.04);">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('admin.upload-image') }}"><i class="fas fa-upload" style="color: var(--bs-accordion-active-color);"></i><span style="color: var(--bs-secondary-text-emphasis);">Upload Image</span></a></li>
                </ul>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <form action="{{ route('admin.upload-image.delete', $image['id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this image?');">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <a href="{{ asset('storage/' . $gcashImage->image) }}" target="_blank">
                                            <img src="{{ asset('storage/' . $gcashImage->image) }}" class="card-img-top" alt="G-Cash Image">
                                        </a>
                                        <div class="card-body text-center">

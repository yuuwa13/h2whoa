        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: rgba(255, 255, 255, 0.04);font-size: 22px;color: rgba(133,135,150,0.04);">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.sales.index') }}"><i class="fas fa-cash-register" style="color: var(--bs-accordion-active-color);"></i><span style="color: var(--bs-secondary-text-emphasis);">Sales</span></a></li>
                        ...
                        <div class="card-body">
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-4 text-md-end">
                                    <button class="btn btn-primary" type="button" style="height: 31px;" onclick="window.location='{{ route('admin.sales.create') }}'">
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.sales.edit', $sale->sale_id) }}" class="btn btn-sm btn-outline-secondary me-2" title="Edit">

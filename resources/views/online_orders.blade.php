...
<body>
    <nav class="navbar navbar-expand-lg fixed-top bg-body clean-navbar navbar-light" style="width: 1335px;height: 163px;margin-left: 32px;margin-top: 30px;border-radius: 42px;">
        <div class="container"><a class="navbar-brand logo" href="orders"><img width="100" height="80" src="{{ asset('h2whoa/assets/img/assets/h2whoa_logo.png')}}">H2WHOA</a><button data-bs-toggle="collapse" data-bs-target="#navcol-1" class="navbar-toggler"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse text-start" id="navcol-1" style="margin-left: 242px;margin-right: 318px;">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item text-center" style="padding-right: 33px;"><a class="nav-link text-end active" href="orders" style="width: 99px;height: 32px;text-align: center;font-size: 22px;">ORDERS</a></li>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="bg-body-tertiary summary">
                                ...
                                <h4><span class="text">Total</span><span class="price">₱360.00</span></h4><button class="btn btn-primary btn-lg d-block w-100" type="button" style="background: #4ac9b0;"><i class="fas fa-arrow-circle-right" style="font-size: 24px;margin-right: 33px;"></i>Check out</button>
                            </div>
                        </div>
                    </div>
                </div>

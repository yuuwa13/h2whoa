                            ...
                            <div class="items">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-6" style="margin-top: 75px;">
                                        <h3 class="text-dark mb-4"><a class="navbar-brand logo" href="#index.html"><img width="100" height="80" src={{ asset('h2whoa/assets/img/assets/Homepage_h2whoa.png') }}>Inventory</a></h3>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-6 text-end" style="margin-bottom: 30px;margin-top: 75px;"><a class="btn btn-primary" role="button" style="background: #4ac9b0;margin-top: 33px;margin-right: 8px;"><i class="fa fa-plus"></i>Add Stocks</a></div>
                                </div>
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table class="table table-striped table tablesorter" id="ipi-table">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th class="text-center" style="font-size: 16px;">PRODUCTS</th>
                                                    <th class="text-center" style="font-size: 16px;">PRICE</th>
                                                    <th class="text-center" style="font-size: 16px;">quantity</th>
                                                    <th class="text-center filter-false sorter-false" style="font-size: 16px;">Update</th>
                                                </tr>
                                            </thead>
                                            <tbody class="text-center">
                                                <tr>
                                                    <td style="font-size: 16px;"><img class="img-fluid d-block mx-auto image" src={{ asset('h2whoa/assets/img/assets/Gallon.png')}} width="89" height="104"><br>Water Gallon (new, refilled) <br><br></td>
                                                    <td><br>₱ 150.00<br><br></td>
                                                    <td>30</td>
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid d-block mx-auto image" src={{ asset('h2whoa/assets/img/assets/Water.png')}} width="62" height="61">Refill Water</td>
                                                    <td><br>₱ 150.00<br><br></td>
                                                    <td>N/A</td>
                                                    <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><a class="btn btnMaterial btn-flat success semicircle" role="button" href="#"><i class="fas fa-pen"></i></a><a class="btn btnMaterial btn-flat accent btnNoBorders checkboxHover" role="button" style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#delete-modal" href="#"><i class="fas fa-trash btnNoBorders" style="color: #DC3545;"></i></a></td>
                                                </tr>
